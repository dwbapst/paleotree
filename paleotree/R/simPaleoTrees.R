...
#' 
#' Essentially a complex wrapper for simFossilTaxa, sampleRanges and
#' taxa2phylo, this function will spit out simulated phylogenies of fossil taxa
...
#' 
#' @param p Instantaneous rate of speciation per lineage-time units
...
#' @param mintime Minimum time to run simulation
#' @param maxtime Maximum time to run simulation
#' @param mintaxa Minimum number of taxa allowed over entire simulation
#' @param maxtaxa Maximum number of taxa allowed over entire simulation
...
#' morphological branching, such as bifurcating and budding. Trees with cryptic
#' taxa are always returned with cryptic taxa unmerged (see sampleRanges).
#' @param drop.zlb Should zero-length branches be dropped?
#' @param print.runs Print the proportion of simulations accepted for output?
