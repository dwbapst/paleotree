...
#' 
#' This function takes a tree composed of higher-leve taxa and a vector of
...
#' the input taxontree, so that such a group would be treated as a paraphyletic
#' group in the output tree.
#' 
#' By default, the output tree will lack branch lengths and thus will not be
